...
urlpatterns = [
    ...
    path('friends/request/', api.my_friendship_requests, name='my_friendship_requests'),
    path('friends/request/byme/', api.requested_friendships, name='requested_friendships'),
